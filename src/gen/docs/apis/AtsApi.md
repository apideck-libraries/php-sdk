 ...
 **filter** | [\Apideck\Client\Model\ApplicantsFilter](../models/\Apideck\Client\Model\ApplicantsFilter.md)| Apply filters |
 **pass_through** | [array<string,object>](../models/array<string,object>.md)| Optional unmapped key/values that will be passed through to downstream as query parameters. Ie: ?pass_through[search]=leads becomes ?search=leads |
