...
/**
 * PosBankAccountAchDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PosBankAccountAchDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PosBankAccount_ach_details';
    ...
    public function setRoutingNumber($routing_number)
    {
        if (!is_null($routing_number) && (mb_strlen($routing_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling PosBankAccountAchDetails., must be smaller than or equal to 50.');
        }
    ...
    public function setAccountNumberSuffix($account_number_suffix)
    {
        if (!is_null($account_number_suffix) && (mb_strlen($account_number_suffix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $account_number_suffix when calling PosBankAccountAchDetails., must be smaller than or equal to 4.');
        }
    ...
    public function setAccountType($account_type)
    {
        if (!is_null($account_type) && (mb_strlen($account_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $account_type when calling PosBankAccountAchDetails., must be smaller than or equal to 50.');
        }
