...
/**
 * CreateSessionResponseData Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateSessionResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSessionResponse_data';
    ...
    {
        $this->container['session_uri'] = $data['session_uri'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['session_uri'] === null) {
            $invalidProperties[] = "'session_uri' can't be null";
        }
