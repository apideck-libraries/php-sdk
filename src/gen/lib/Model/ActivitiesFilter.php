...
/**
 * ActivitiesFilter Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActivitiesFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivitiesFilter';
     ...
     * Sets contact_id
     *
     * @param string|null $contact_id Primary contact ID to filter on
     *
     * @return self
     */
