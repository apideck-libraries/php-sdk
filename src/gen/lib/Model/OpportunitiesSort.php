...
/**
 * OpportunitiesSort Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class OpportunitiesSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpportunitiesSort';
    ...
    const BY_WIN_PROBABILITY = 'win_probability';
    const BY_MONETARY_AMOUNT = 'monetary_amount';
    ...
    public function getByAllowableValues()
    {
        return [
            ...
            self::BY_UPDATED_AT,
            self::BY_TITLE,
            self::BY_WIN_PROBABILITY,
            self::BY_MONETARY_AMOUNT,
            self::BY_STATUS,
        ];
    }
     ...
     * Sets by
     *
     * @param string $by The field on which to sort the Opportunities
     *
     * @return self
     */
