...
/**
 * InvoicesFilter Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvoicesFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicesFilter';
     ...
     * Sets number
     *
     * @param string|null $number Invoice number to search for
     *
     * @return self
     */
