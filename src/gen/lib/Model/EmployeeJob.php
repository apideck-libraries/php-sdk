 ...
 */
class EmployeeJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeJob';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_manager'] = $data['is_manager'] ?? null;
     ...
     * Sets is_manager
     *
     * @param bool|null $is_manager Indicates whether this the employee has a manager role.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Indicates the status of the job.
     *
     * @return self
     */
