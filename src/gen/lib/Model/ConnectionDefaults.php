...
/**
 * ConnectionDefaults Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConnectionDefaults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Connection_defaults';
    ...
    const TARGET_CUSTOM_FIELDS = 'custom_fields';
