...
/**
 * InvoicePaymentAllocations Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePaymentAllocations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Invoice_payment_allocations';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['allocated_amount'] = $data['allocated_amount'] ?? null;
     ...
     * Sets id
     *
     * @param string|null $id ID of the payment
     *
     * @return self
     */
     ...
     *
     * @param float|null $allocated_amount Amount of the payment allocated to the invoice
     *
     * @return self
     */
