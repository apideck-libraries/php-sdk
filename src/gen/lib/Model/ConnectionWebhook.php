...
/**
 * ConnectionWebhook Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConnectionWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectionWebhook';
    ...
    const EVENTS_ACCOUNTING_PURCHASE_ORDER_CREATED = 'accounting.purchase_order.created';
    const EVENTS_ACCOUNTING_PURCHASE_ORDER_UPDATED = 'accounting.purchase_order.updated';
    const EVENTS_ACCOUNTING_PURCHASE_ORDER_DELETED = 'accounting.purchase_order.deleted';
    const EVENTS_ACCOUNTING_CREDIT_NOTE_CREATED = 'accounting.credit_note.created';
    const EVENTS_ACCOUNTING_CREDIT_NOTE_UPDATED = 'accounting.credit_note.updated';
    const EVENTS_ACCOUNTING_CREDIT_NOTE_DELETED = 'accounting.credit_note.deleted';
    ...
    const EVENTS_ACCOUNTING_EXPENSE_CREATED = 'accounting.expense.created';
    const EVENTS_ACCOUNTING_EXPENSE_UPDATED = 'accounting.expense.updated';
    const EVENTS_ACCOUNTING_EXPENSE_DELETED = 'accounting.expense.deleted';
    const EVENTS_ECOMMERCE_ORDER_CREATED = 'ecommerce.order.created';
    const EVENTS_ECOMMERCE_ORDER_UPDATED = 'ecommerce.order.updated';
    const EVENTS_ECOMMERCE_ORDER_DELETED = 'ecommerce.order.deleted';
    const EVENTS_ECOMMERCE_PRODUCT_CREATED = 'ecommerce.product.created';
    const EVENTS_ECOMMERCE_PRODUCT_UPDATED = 'ecommerce.product.updated';
    const EVENTS_ECOMMERCE_PRODUCT_DELETED = 'ecommerce.product.deleted';
    const EVENTS_ECOMMERCE_CUSTOMER_CREATED = 'ecommerce.customer.created';
    const EVENTS_ECOMMERCE_CUSTOMER_UPDATED = 'ecommerce.customer.updated';
    const EVENTS_ECOMMERCE_CUSTOMER_DELETED = 'ecommerce.customer.deleted';
    ...
    public function getEventsAllowableValues()
    {
        return [
            ...
            self::EVENTS_ACCOUNTING_CREDIT_NOTE_CREATED,
            self::EVENTS_ACCOUNTING_CREDIT_NOTE_UPDATED,
            self::EVENTS_ACCOUNTING_CREDIT_NOTE_DELETED,
            ...
            self::EVENTS_ACCOUNTING_EXPENSE_CREATED,
            self::EVENTS_ACCOUNTING_EXPENSE_UPDATED,
            self::EVENTS_ACCOUNTING_EXPENSE_DELETED,
            self::EVENTS_ECOMMERCE_ORDER_CREATED,
            self::EVENTS_ECOMMERCE_ORDER_UPDATED,
            self::EVENTS_ECOMMERCE_ORDER_DELETED,
            self::EVENTS_ECOMMERCE_PRODUCT_CREATED,
            self::EVENTS_ECOMMERCE_PRODUCT_UPDATED,
            self::EVENTS_ECOMMERCE_PRODUCT_DELETED,
            self::EVENTS_ECOMMERCE_CUSTOMER_CREATED,
            self::EVENTS_ECOMMERCE_CUSTOMER_UPDATED,
            self::EVENTS_ECOMMERCE_CUSTOMER_DELETED,
        ];
    }
    ...
    public function setDeliveryUrl($delivery_url)
    {
        ...
        if ((!preg_match("/^(https?):\/\//", $delivery_url))) {
            throw new \InvalidArgumentException("invalid value for $delivery_url when calling ConnectionWebhook., must conform to the pattern /^(https?):\/\//.");
        }
    ...
    public function setExecuteBaseUrl($execute_base_url)
    {
        ...
        if ((!preg_match("/^(https?):\/\//", $execute_base_url))) {
            throw new \InvalidArgumentException("invalid value for $execute_base_url when calling ConnectionWebhook., must conform to the pattern /^(https?):\/\//.");
        }
