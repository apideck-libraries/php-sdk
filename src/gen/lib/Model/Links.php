...
class Links implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets previous
     *
     * @param string|null $previous Link to navigate to the previous page through the API
     *
     * @return self
     */
     ...
     * Sets current
     *
     * @param string|null $current Link to navigate to the current page through the API
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string|null $next Link to navigate to the previous page through the API
     *
     * @return self
     */
