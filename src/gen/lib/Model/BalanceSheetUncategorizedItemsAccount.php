...
/**
 * BalanceSheetUncategorizedItemsAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class BalanceSheetUncategorizedItemsAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Balance_Sheet_Uncategorized_Items_Account';
     ...
     * Sets value
     *
     * @param float|null $value The amount or value of the item
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param AnyOfBalanceSheetAccountBalanceSheetAccountRecord[]|null $items A list of balance sheet accounts
     *
     * @return self
     */
