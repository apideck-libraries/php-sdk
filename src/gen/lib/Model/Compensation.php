...
class Compensation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const PAYMENT_FREQUENCY_PRO_RATA = 'pro-rata';
    const PAYMENT_FREQUENCY_OTHER = 'other';
    ...
    {
        return [
            self::PAYMENT_FREQUENCY_WEEKLY,
            self::PAYMENT_FREQUENCY_BIWEEKLY,
            self::PAYMENT_FREQUENCY_MONTHLY,
            self::PAYMENT_FREQUENCY_PRO_RATA,
            self::PAYMENT_FREQUENCY_OTHER,
        ];
    }
     ...
     *
     * @param string|null $payment_frequency Frequency of employee compensation.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getPaymentFrequencyAllowableValues();
        if (!is_null($payment_frequency) && !in_array($payment_frequency, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'payment_frequency', must be one of '%s'",
                    $payment_frequency,
