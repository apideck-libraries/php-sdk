...
/**
 * ModifierGroupFilter Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModifierGroupFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModifierGroupFilter';
     ...
     *
     * @param string|null $modifier_group_id Id of the job to filter on
     *
     * @return self
     */
