...
/**
 * ConnectorWebhookSupportType Class Doc Comment
 *
 * @category Class
 * @description Describes the configurations webhook support of the connector.
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ConnectorWebhookSupportType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Connector_webhook_support_type';
    ...
    const SUBSCRIPTION_LEVEL_CONSUMER = 'consumer';
    ...
    {
        return [
            self::SUBSCRIPTION_LEVEL_CONSUMER,
     ...
     *
     * @param string|null $subscription_level Received events are scoped to consumer or across integration.
     *
     * @return self
     */
