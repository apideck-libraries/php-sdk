...
/**
 * LinkedLedgerAccount Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class LinkedLedgerAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinkedLedgerAccount';
     ...
     * Sets nominal_code
     *
     * @param string|null $nominal_code The nominal code of the account.
     *
     * @return self
     */
