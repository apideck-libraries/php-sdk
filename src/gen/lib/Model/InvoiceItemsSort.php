...
/**
 * InvoiceItemsSort Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceItemsSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceItemsSort';
     ...
     * Sets by
     *
     * @param string|null $by The field on which to sort the Invoice Items
     *
     * @return self
     */
