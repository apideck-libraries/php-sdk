 ...
 */
class ConnectorEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectorEvent';
    ...
    const EVENT_SOURCE_NATIVE = 'native';
    const EVENT_SOURCE_VIRTUAL = 'virtual';
    ...
    {
        return [
            self::EVENT_SOURCE_NATIVE,
            self::EVENT_SOURCE_VIRTUAL,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['event_source'] = $data['event_source'] ?? null;
     ...
     * Sets event_type
     *
     * @param string|null $event_type Unify event type
     *
     * @return self
     */
     ...
     * Sets event_source
     *
     * @param string|null $event_source Unify event source
     *
     * @return self
     */
     ...
     *
     * @param string|null $downstream_event_type Downstream event type
     *
     * @return self
     */
     ...
     * Sets resource
     *
     * @param string|null $resource ID of the resource, typically a lowercased version of name.
     *
     * @return self
     */
