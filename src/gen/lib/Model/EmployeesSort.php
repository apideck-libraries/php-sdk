...
/**
 * EmployeesSort Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmployeesSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeesSort';
     ...
     * Sets by
     *
     * @param string|null $by The field on which to sort the Employees
     *
     * @return self
     */
