...
/**
 * SuppliersSort Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class SuppliersSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuppliersSort';
     ...
     * Sets by
     *
     * @param string|null $by The field on which to sort the Suppliers
     *
     * @return self
     */
