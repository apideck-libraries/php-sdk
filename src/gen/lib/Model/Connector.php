...
class Connector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'schema_support' => '\Apideck\Client\Model\SchemaSupport',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['webhook_support'] = $data['webhook_support'] ?? null;
     ...
     * Sets signup_url
     *
     * @param string|null $signup_url Link to the connector's signup page.
     *
     * @return self
     */
    ...
    /**
     * Gets free_trial_available
     *
     * @return bool|null
     */
    public function getFreeTrialAvailable()
    {
        return $this->container['free_trial_available'];
    }

    /**
     * Sets free_trial_available
     *
     * @param bool|null $free_trial_available Set to `true` when the connector offers a free trial. Use `signup_url` to sign up for a free trial
     *
     * @return self
     */
    public function setFreeTrialAvailable($free_trial_available)
    {
        $this->container['free_trial_available'] = $free_trial_available;
     ...
     * Gets schema_support
     *
     * @return \Apideck\Client\Model\SchemaSupport|null
     */
     ...
     * Sets schema_support
     *
     * @param \Apideck\Client\Model\SchemaSupport|null $schema_support schema_support
     *
     * @return self
     */
