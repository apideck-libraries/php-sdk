...
/**
 * CreditNotesSort Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreditNotesSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNotesSort';
     ...
     * Sets by
     *
     * @param string|null $by The field on which to sort the Customers
     *
     * @return self
     */
