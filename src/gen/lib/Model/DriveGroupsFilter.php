...
/**
 * DriveGroupsFilter Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class DriveGroupsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DriveGroupsFilter';
     ...
     *
     * @param string|null $parent_group_id ID of the drive group to filter on
     *
     * @return self
     */
