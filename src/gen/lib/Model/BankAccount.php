...
class BankAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ach_details' => '\Apideck\Client\Model\BankAccountAchDetails'
    ];
    ...
    public function setBankName($bank_name)
    {
        if (!is_null($bank_name) && (mb_strlen($bank_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling BankAccount., must be smaller than or equal to 100.');
        }
    ...
    public function setTransferType($transfer_type)
    {
        if (!is_null($transfer_type) && (mb_strlen($transfer_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $transfer_type when calling BankAccount., must be smaller than or equal to 50.');
        }
    ...
    public function setAccountOwnershipType($account_ownership_type)
    {
        if (!is_null($account_ownership_type) && (mb_strlen($account_ownership_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $account_ownership_type when calling BankAccount., must be smaller than or equal to 50.');
        }
    ...
    public function setFingerprint($fingerprint)
    {
        if (!is_null($fingerprint) && (mb_strlen($fingerprint) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fingerprint when calling BankAccount., must be smaller than or equal to 255.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling BankAccount., must be smaller than or equal to 2.');
        }
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling BankAccount., must be bigger than or equal to 2.');
        }
    ...
    public function setStatementDescription($statement_description)
    {
        if (!is_null($statement_description) && (mb_strlen($statement_description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $statement_description when calling BankAccount., must be smaller than or equal to 1000.');
        }
     ...
     * Gets ach_details
     *
     * @return \Apideck\Client\Model\BankAccountAchDetails|null
     */
     ...
     * Sets ach_details
     *
     * @param \Apideck\Client\Model\BankAccountAchDetails|null $ach_details ach_details
     *
     * @return self
     */
