...
/**
 * JournalEntriesSort Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class JournalEntriesSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JournalEntriesSort';
     ...
     * Sets by
     *
     * @param string|null $by The field on which to sort the Journal Entries.
     *
     * @return self
     */
