...
/**
 * EcommerceOrdersFilter Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class EcommerceOrdersFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EcommerceOrdersFilter';
     ...
     * Sets email
     *
     * @param string|null $email Customer email address to filter on
     *
     * @return self
     */
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id Customer id to filter on
     *
     * @return self
     */
