...
/**
 * BillPaymentAllocations Class Doc Comment
 *
 * @category Class
 * @package  Apideck\Client
 * @author   OpenAPI Generator team
 ...
 */
class BillPaymentAllocations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillPayment_allocations';
     ...
     * Sets type
     *
     * @param string|null $type Type of entity this payment should be attributed to.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Amount of payment that should be attributed to this allocation. If null, the total_amount will be used.
     *
     * @return self
     */
