...
class WebhookEventType
{
    ...
    const ACCOUNTING_CREDIT_NOTE_CREATED = 'accounting.credit_note.created';

    const ACCOUNTING_CREDIT_NOTE_UPDATED = 'accounting.credit_note.updated';

    const ACCOUNTING_CREDIT_NOTE_DELETED = 'accounting.credit_note.deleted';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::ACCOUNTING_CREDIT_NOTE_CREATED,
            self::ACCOUNTING_CREDIT_NOTE_UPDATED,
            self::ACCOUNTING_CREDIT_NOTE_DELETED,
