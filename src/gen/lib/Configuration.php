...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'Apideck-php-sdk/3.5.2 Unify-spec/10.7.2';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 10.7.2' . PHP_EOL;
        $report .= '    SDK Package Version: 3.5.2' . PHP_EOL;
