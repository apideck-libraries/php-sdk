...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'Apideck-php-sdk/3.6.1 Unify-spec/10.8.3';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 10.8.3' . PHP_EOL;
        $report .= '    SDK Package Version: 3.6.1' . PHP_EOL;
