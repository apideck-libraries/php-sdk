...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://unify.apideck.com';
     ...
     * @var string
     */
    protected $userAgent = 'Apideck-php-sdk/3.5.3 Unify-spec/10.7.5';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 10.7.5' . PHP_EOL;
        $report .= '    SDK Package Version: 3.5.3' . PHP_EOL;
