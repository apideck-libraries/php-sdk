...
class AccountingApi
{
     ...
     */
    public function balanceSheetOne($x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $pass_through = null, $raw = false)
    {
        list($response) = $this->balanceSheetOneWithHttpInfo($x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $pass_through, $raw);
        return $response;
    }
     ...
     */
    public function balanceSheetOneWithHttpInfo($x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $pass_through = null, $raw = false)
    {
        $request = $this->balanceSheetOneRequest($x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $pass_through, $raw);
     ...
     */
    public function balanceSheetOneAsync($x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $pass_through = null, $raw = false)
    {
        return $this->balanceSheetOneAsyncWithHttpInfo($x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $pass_through, $raw)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function balanceSheetOneAsyncWithHttpInfo($x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $pass_through = null, $raw = false)
    {
        $returnType = '\Apideck\Client\Model\GetBalanceSheetResponse';
        $request = $this->balanceSheetOneRequest($x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $pass_through, $raw);
     ...
     */
    public function balanceSheetOneRequest($x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $pass_through = null, $raw = false)
    {
     ...
     */
    public function billsAll($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        list($response) = $this->billsAllWithHttpInfo($raw, $x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $cursor, $limit);
        return $response;
    }
     ...
     */
    public function billsAllWithHttpInfo($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        $request = $this->billsAllRequest($raw, $x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $cursor, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function billsAllAsync($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        return $this->billsAllAsyncWithHttpInfo($raw, $x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $cursor, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function billsAllAsyncWithHttpInfo($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        $returnType = '\Apideck\Client\Model\GetBillsResponse';
        $request = $this->billsAllRequest($raw, $x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $cursor, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function billsAllRequest($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
     ...
     * @param  string $cursor Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response. (optional)
     * @param  int $limit Number of records to return (optional, default to 20)
     * @param  \Apideck\Client\Model\CustomersFilter $filter Apply filters (beta) (optional)
     *
     * @throws \Apideck\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $cursor Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response. (optional)
     * @param  int $limit Number of records to return (optional, default to 20)
     * @param  \Apideck\Client\Model\InvoiceItemsFilter $filter Apply filters (beta) (optional)
     *
     * @throws \Apideck\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $x_apideck_app_id The ID of your Unify application (optional)
     * @param  string $x_apideck_service_id Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API. (optional)
     * @param  \Apideck\Client\Model\ProfitAndLossFilter $filter Apply filters (beta) (optional)
     *
     * @throws \Apideck\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function suppliersAll($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        list($response) = $this->suppliersAllWithHttpInfo($raw, $x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $cursor, $limit);
        return $response;
    }
     ...
     * @return array of \Apideck\Client\Model\GetSuppliersResponse|\Apideck\Client\Model\BadRequestResponse|\Apideck\Client\Model\UnauthorizedResponse|\Apideck\Client\Model\PaymentRequiredResponse|\Apideck\Client\Model\NotFoundResponse|\Apideck\Client\Model\UnprocessableResponse|\Apideck\Client\Model\UnexpectedErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function suppliersAllWithHttpInfo($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        $request = $this->suppliersAllRequest($raw, $x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $cursor, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suppliersAllAsync($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        return $this->suppliersAllAsyncWithHttpInfo($raw, $x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $cursor, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suppliersAllAsyncWithHttpInfo($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        $returnType = '\Apideck\Client\Model\GetSuppliersResponse';
        $request = $this->suppliersAllRequest($raw, $x_apideck_consumer_id, $x_apideck_app_id, $x_apideck_service_id, $cursor, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function suppliersAllRequest($raw = false, $x_apideck_consumer_id = null, $x_apideck_app_id = null, $x_apideck_service_id = null, $cursor = null, $limit = 20)
    {
        if ($limit !== null && $limit > 200) {
